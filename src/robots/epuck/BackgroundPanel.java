...
public class BackgroundPanel extends JPanel {
	...
	public static final Image state_background = new ImageIcon(BackgroundPanel.class
			.getResource("e-puck-background.png")).getImage();
	public static final Image trans_background = new ImageIcon(BackgroundPanel.class
			.getResource("trans_background.png")).getImage();
	public static final Image debug_background = new ImageIcon(BackgroundPanel.class
			.getResource("debug_background.png")).getImage();

	private Image background;

//	public Shape[] sensorShapes = { new Rectangle2D.Double(137, 41, 35, 27), new Rectangle2D.Double(60, 83, 38, 28),
//			new Rectangle2D.Double(29, 184, 33, 31), new Rectangle2D.Double(108, 316, 30, 38),
//			new Rectangle2D.Double(262, 320, 33, 30), new Rectangle2D.Double(336, 186, 35, 30),
//			new Rectangle2D.Double(292, 81, 44, 28), new Rectangle2D.Double(229, 33, 31, 38),
//			new Rectangle2D.Double(134, 102, 32, 40), new Rectangle2D.Double(185, 102, 32, 40),
//			new Rectangle2D.Double(234, 102, 32, 40), new Rectangle2D.Double(160, 238, 80, 32) };

	// Positionen für die Anzeige der Werte (x,y,rotation)
	private ValuePosition[] labelPos = { new ValuePosition(220, 61, Math.PI / 9.5),
			new ValuePosition(290, 93, Math.PI / 3.5), new ValuePosition(339, 180, Math.PI / 2),
			new ValuePosition(257, 340, Math.PI / -5.5), new ValuePosition(110, 320, Math.PI / 6),
			new ValuePosition(60, 226, Math.PI / -2), new ValuePosition(83, 126, Math.PI / -3.5),
			new ValuePosition(136, 75, Math.PI / -10), new ValuePosition(126, 143, 0), new ValuePosition(179, 143, 0),
