...
public class BeepStatePanel extends AbstractStatePanel implements
	...
	private void setComponentBounds() {
		...
		try {
			...
			if(led.hasNext())
				System.err.println("Do not have enough led-positions for led-amount. Check setComponentBounds in BeepStatePanel!");
		} catch (Exception e) {
			System.err.println("Tried to set to many led-positions. Check setComponentBounds in BeepStatePanel!");
		}
